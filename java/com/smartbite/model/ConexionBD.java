...
/**
 * Conexión a la base de datos de SmartBite.
 * Adaptado del modelo jakarta-docker-compose-project (ConexionBD.java).
 */
public class ConexionBD {

    private static final String DB_HOST = System.getenv().getOrDefault("DB_HOST", "mysql");
    private static final String DB_PORT = System.getenv().getOrDefault("DB_PORT", "3306");
    private static final String DB_NAME = System.getenv().getOrDefault("DB_NAME", "smartbite_db");
